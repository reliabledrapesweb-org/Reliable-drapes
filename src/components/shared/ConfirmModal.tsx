                        ...
                        >
                            ...
                            <div className="px-6 pt-6 pb-4">
                                ...
                                <div className="flex justify-center mb-4">
                                    <div className={`h-16 w-16 rounded-full ${styles.iconBg} flex items-center justify-center`}>
                                ...
                                <div className="text-center">
                                    <h2 className="text-xl font-bold text-[#2a2a2a] mb-2 uppercase">
                                        {title}
                                    </h2>
                            ...
                            <div className="px-6 pb-6 pt-2 flex gap-3">
                                ...
                                <button
                                    ...
                                    disabled={isLoading}
                                    className={`flex-1 px-4 py-3 text-sm rounded-full ${styles.confirmButton} text-white font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2`}
                                >
                                    {isLoading ? (
                                        <>
