      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              {/* Icon */}
              <div className="w-24 h-24 mb-6 flex items-center justify-center bg-white rounded-full shadow-sm transition-transform duration-300 group-hover:scale-110 group-hover:shadow-md">
                <Image
                  width={100}
                  height={100}
                  src={feature.icon}
              ...
              <p className="text-[#575757] max-w-xs leading-relaxed">{feature.description}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
