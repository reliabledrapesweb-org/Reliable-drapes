...
export function AdminDashboardSkeleton() {
  return (
    <div className="space-y-6">
      {/* Welcome Section */}
      <div className="space-y-2">
        <div className="h-8 w-64 animate-pulse rounded bg-gray-200 sm:h-10 sm:w-80" />
        <div className="h-5 w-96 animate-pulse rounded bg-gray-200 sm:w-[32rem]" />
      </div>

      {/* Stats Grid - 6 large cards */}
            ...
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-start justify-between">
                <div className="flex-1 space-y-2">
                  <div className="h-4 w-20 animate-pulse rounded bg-gray-200 sm:w-24" />
                  <div className="h-8 w-12 animate-pulse rounded bg-gray-200 sm:h-10 sm:w-16" />
                  <div className="flex items-center gap-1">
                    <div className="h-3 w-3 animate-pulse rounded bg-gray-200" />
                    <div className="h-3 w-8 animate-pulse rounded bg-gray-200" />
                  </div>
                </div>
                <div className="h-10 w-10 animate-pulse rounded-xl bg-gray-200 sm:h-12 sm:w-12" />
              </div>
            </CardContent>
          </Card>
        ))}
