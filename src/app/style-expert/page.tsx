          ...
          <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-4xl text-center">
              <motion.div
                ...
                className="rounded-3xl bg-white p-12 shadow-2xl border border-gray-100"
              >
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
              ...
              <div className="flex flex-col justify-center">
                <motion.div
                  ...
                  className="mb-6 inline-flex items-center rounded-full bg-[#2f2582]/10 px-4 py-2 text-sm font-semibold text-[#2f2582] w-fit"
                >
                ...
                <motion.h1
                  ...
                  className="mb-6 text-4xl font-bold leading-tight text-[#2a2a2a] lg:text-5xl"
                >
                  Transform Your Space with Our
                  <span className="block bg-gradient-to-r from-[#2f2582] to-[#4c3d9e] bg-clip-text text-transparent">Style Experts</span>
                </motion.h1>
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute -bottom-6 -left-6 rounded-2xl bg-white p-6 shadow-xl border border-gray-100"
                >
