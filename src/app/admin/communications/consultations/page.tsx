                  ...
                  <div className="min-w-0 flex-1">
                    <div className="mb-2 flex flex-wrap items-center gap-2">
                      ...
                      {request.priority && request.priority !== "medium" && (
                        <span
                          className={`inline-flex items-center rounded-full border px-2 py-0.5 text-xs font-medium ${getPriorityColor(request.priority)}`}
                        >
        ...
        {selectedRequest && (
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                {selectedRequest.property_type && (
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">
                      {getPropertyTypeDisplay(selectedRequest.property_type)}
                    </p>
                  </div>
                )}
                {selectedRequest.room_types &&
                  selectedRequest.room_types.length > 0 && (
            ...
            {selectedRequest.style_preferences &&
              selectedRequest.style_preferences.length > 0 && (
                <div className="rounded-lg bg-gray-50 p-4">
                  <h3 className="mb-3 text-sm font-semibold tracking-wide text-gray-700 uppercase">
                    Style Preferences
                  </h3>
            ...
            <div className="rounded-lg bg-gray-50 p-4">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  ...
                  <p className="mt-1">
                    <span
                      className={`inline-flex items-center gap-1 rounded-full px-3 py-1 text-xs font-medium ${getStatusColor(selectedRequest.status)}`}
                    >
                ...
                {selectedRequest.priority && (
                  <div>
                    ...
                    <p className="mt-1">
                      <span
                        className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium ${getPriorityColor(selectedRequest.priority)}`}
                      >
                ...
                {selectedRequest.converted_to_sale && (
                  <div>
                    ...
                    <p className="mt-1 text-sm font-medium text-green-600">
                      Yes{" "}
                      {selectedRequest.sale_amount &&
                        `- ₹${selectedRequest.sale_amount.toLocaleString()}`}
                    </p>
                  </div>
                )}
              </div>
            ...
            {selectedRequest.admin_notes && (
              <div className="rounded-lg bg-yellow-50 p-4">
                <h3 className="mb-3 text-sm font-semibold tracking-wide text-yellow-800 uppercase">
                  Admin Notes
                </h3>
                <p className="text-sm whitespace-pre-wrap text-yellow-900">
                  {selectedRequest.admin_notes}
                </p>
              </div>
            )}
