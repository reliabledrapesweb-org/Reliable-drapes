...
import { getOrderByIdAction, updateOrderStatusAction } from "@/lib/actions/orders";
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="relative">
                        <select
                            ...
                            disabled={isUpdating}
                            className="appearance-none rounded-lg border border-gray-300 bg-white px-4 py-2 pr-8 text-sm font-medium text-gray-700 shadow-sm focus:border-[#2f2582] focus:outline-none focus:ring-1 focus:ring-[#2f2582] disabled:opacity-50"
                        >
                                    ...
                                    <div className="flex flex-1 flex-col justify-between">
                                        <div className="flex justify-between">
                                            ...
                                            <p className="font-medium text-gray-900">
                                                {formatPrice(item.price_snapshot || item.product?.price || 0)}
                                            </p>
                                        </div>
                    ...
                    <div className="rounded-xl border border-gray-200 bg-white shadow-sm">
                        ...
                        <div className="p-6 space-y-6">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-gray-900">{order.user?.full_name || "Guest"}</p>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-gray-900">{order.user?.phone || "N/A"}</p>
                                ...
                                <div className="text-sm text-gray-600">
                                    ...
                                    {order.user?.address_line1 || order.user?.city ? (
                                        <>
                                            ...
                                            <p>{order.user.city}, {order.user.country}</p>
                                        </>
                                    ) : (
