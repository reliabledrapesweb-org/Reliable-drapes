...
export default function AdminCollectionsPage() {
  ...
  const executeDelete = async () => {
    ...
    setActionLoading((prev) => ({
      ...prev,
      [`delete-${confirmAction.collectionId}`]: "delete",
    }));
    ...
    try {
      ...
      setActionLoading((prev) => ({
        ...prev,
        [`delete-${confirmAction.collectionId}`]: null,
      }));
    }
  };
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-xs text-gray-600 sm:text-sm">
            Manage product collections and featured sets
          </p>
        </div>
        <Button
            ...
            <>
              ...
              <div className="divide-y divide-gray-100 sm:hidden">
                {filteredCollections.map((collection) => (
                  <div key={collection.id} className="space-y-3 p-4">
                ...
                <div>
                  ...
                  <div className="relative mb-3">
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border-2 border-gray-200 py-2 pr-4 pl-10 text-sm transition-colors focus:border-[#2F2582] focus:ring-2 focus:ring-[#2F2582]/20 focus:outline-none"
                    />
                  </div>
                    ...
                    {products.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {products
                          ...
                          .map((product) => {
                            const isSelected = formData.productIds.includes(
                              product.id,
                            );
                            return (
                              <label
                              ...
                              >
                                ...
                                <div className="min-w-0 flex-1">
                                  <div
                                    className={`truncate text-sm font-medium ${isSelected ? "text-[#2F2582]" : "text-gray-900"}`}
                                  >
                                    {product.name}
                                  </div>
                  ...
                  {formData.productIds.length > 0 && (
                    <p className="mt-2 text-xs font-medium text-[#2F2582]">
      ...
      <ConfirmationModal
        ...
        variant="danger"
        isLoading={
          actionLoading[`delete-${confirmAction.collectionId}`] === "delete"
        }
      />
