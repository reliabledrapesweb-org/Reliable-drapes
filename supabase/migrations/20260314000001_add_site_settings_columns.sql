...
ALTER TABLE site_settings
  ...
  -- Contact Us page "Call" button number (admin-editable, distinct from company_phone)
...
-- company_phone was incorrectly set to the HR number; correct it to the main company line
